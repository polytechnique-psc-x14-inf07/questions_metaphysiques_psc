...
\answer[Clément]{En gros et dans l'ordre : \verb!git init!, \verb!git clone!, \verb!git fetch!, \verb!git log!, \verb!git pull!, \verb!git add/rm/mv!, \verb!git commit!, \verb!git push!, \verb!git checkout!, \verb!git merge!, \verb!git rebase!.

Une commande pour avoir un joli log : \\
\verb!git log --all --oneline --decorate --graph!}
